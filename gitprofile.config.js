...
const config = {
  github: {
    ...
    exclude: {
      ...
      projects: ['dekompel','spamz'], // These projects will not be displayed. example: ['my-project1', 'my-project2']
    },
  },
  social: {
    linkedin: '',
  ...
  googleAnalytics: {
    id: 'G-TGZW27YY3W', // GA3 tracking id/GA4 tag id UA-XXXXXXXXX-X | G-XXXXXXXXXX
  },
